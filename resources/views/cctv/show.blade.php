...
<body class="bg-gray-100 p-6">
    <div class="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-3xl font-bold text-gray-800">Camera Details</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-gray-50 p-6 rounded-lg shadow">
                ...
                <div class="grid grid-cols-2 gap-4 text-gray-700">
                    ...
                    <span class="font-semibold">Brand:</span> <span>{{ $camera->brand }}</span>
                    <span class="font-semibold">Model:</span> <span>{{ $camera->model }}</span>
                    <span class="font-semibold">Name:</span> <span>{{ $camera->name }}</span>
                    <span class="font-semibold">Location:</span> <span>{{ $camera->location }}</span>
                    <span class="font-semibold">Username:</span> <span>{{ $camera->username }}</span>
                    <span class="font-semibold">Password:</span> <span>{{ $camera->password }}</span>
                    <span class="font-semibold">RTSP URL:</span>
                    <span class="break-all text-blue-600">{{ $camera->rtsp }}</span>
                    <span class="font-semibold">Created At:</span> <span>{{ $camera->created_at }}</span>
                    <span class="font-semibold">Updated At:</span> <span>{{ $camera->updated_at }}</span>
                </div>
