            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text" id="daily-total">{{ $dailyTotalDahua }}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text" id="weekly-total">{{ $weeklyTotalDahua }}</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text" id="monthly-total">{{ $monthlyTotalDahua }}</p>
                    </div>
                </div>
            </div>
        </div>
